...
def start_local_agent(memory_id: str, region: str, stack_name: str) -> subprocess.Popen:
    """
...
Notes:
  ...
  - Local mode: Starts the single Strands agent from agent/main.py
...
def main():
    ...
    if args.local:
        ...
        if check_port_available(8080):
            ...
            # Start the agent
            start_local_agent(memory_id, region, stack_name)
