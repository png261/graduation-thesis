...
ProjectJobKind = Literal["pipeline", "apply", "plan", "ansible", "graph", "cost", "chat"]
ProjectJobStatus = Literal["queued", "running", "succeeded", "failed", "canceled"]

JOB_KINDS: tuple[ProjectJobKind, ...] = ("pipeline", "apply", "plan", "ansible", "graph", "cost", "chat")
...
MUTATING_JOB_KINDS = {"apply", "ansible", "pipeline"}
